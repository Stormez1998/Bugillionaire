...
# this mutex / multithreaded setup is totally overkill, but it's already here.
# It would be much better to have a multithreading system in your game and now have this script do it.
